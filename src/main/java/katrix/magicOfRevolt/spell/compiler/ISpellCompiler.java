...
public interface ISpellCompiler extends ICapabilitySerializable<NBTTagCompound>, IItemHandlerModifiable {
	 ...
	 * @param container The container to set. Do note that the container might be converted to the
	 ...
	 * @return The parameter stored at the specific id. This method is NOT guaranteed to return the
	 * same as you set when using {@link #setContainerForId(int, ISpellContainer)}. The spell will
	 * be the same, but other data can be lost.
	 */
